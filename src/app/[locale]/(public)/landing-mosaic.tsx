...
export default function LandingMosaic() {
  ...
  const [postAuthRedirect, setPostAuthRedirect] = useState("/overview");
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden" style={{ background: "#FAFAFA" }}>
      ...
      >
        ...
        {/* ---- Hero content — top 60% ---- */}
        <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 pb-[38vh]">
          {/* Badge */}
          <motion.div
      ...
      <section className="relative py-24 md:py-32 overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 70% 60% at 50% 50%, rgba(224,231,255,0.7) 0%, rgba(250,250,250,0.9) 70%, #FAFAFA 100%)",
          }}
        />
        {/* Decorative large mosaic tiles in corner */}
        <div
          className="absolute top-0 start-0 w-48 h-48 pointer-events-none opacity-20"
          aria-hidden="true"
        >
          <div className="grid grid-cols-6 gap-1 w-full h-full p-2">
            {Array.from({ length: 36 }).map((_, i) => {
              const colors = ["#0038b8", "#4f46e5", "#93a8f5", "#c7d4fb", "#818cf8", "#e0e7ff"];
              return (
                <div
                  key={i}
        ...
        <div
          className="absolute bottom-0 end-0 w-48 h-48 pointer-events-none opacity-20"
          aria-hidden="true"
        >
          <div className="grid grid-cols-6 gap-1 w-full h-full p-2">
            {Array.from({ length: 36 }).map((_, i) => {
        ...
        >
          {/* Icon */}
          <div className="mb-7 inline-flex size-16 items-center justify-center rounded-2xl border border-brand/20 bg-white shadow-sm">
          ...
          <h2 className="mb-4 text-3xl font-bold tracking-tight text-gray-900 md:text-4xl leading-tight">
            {locale === "he" ? "יחד ננצח" : "Together we overcome"}
          </h2>
          <p className="mb-10 text-gray-500 text-base md:text-lg leading-relaxed">
            {locale === "he"
              ? "הצטרפו לאלפי ישראלים שכבר משתמשים בפלטפורמה. אין צורך ברישום כדי להתחיל."
              : "Join thousands of Israelis already using the platform. No sign-up required to get started."}
          </p>
            ...
            {isSignedIn ? (
              ...
              <>
                ...
                >
                  ...
                  {locale === "he" ? "המשך כאורח" : "Continue as guest"}
                </Button>
              </>
            )}
          </div>
          ...
          <div className="mt-8 flex items-center justify-center gap-2">
            ...
            <span className="text-xs text-gray-400">
              {locale === "he"
                ...
                : "Free. No credit card. Fully secure."}
            </span>
          </div>
          ...
          <div className="mt-6 flex items-center justify-center">
            <button
              ...
              className="text-xs text-gray-400 hover:text-brand transition-colors underline underline-offset-2"
            >
              {t("agent.areYouAgent")}{" "}
              <span className="font-medium">{t("agent.agentSignIn")}</span>
            </button>
          </div>
        </motion.div>
      </section>
              ...
              {!showEmailForm ? (
                <>
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 rounded-xl bg-brand px-4 py-3 text-sm font-medium text-white shadow-sm shadow-brand/20 hover:bg-brand/90 transition-all active:scale-[0.98]"
                  >
                    {locale === "he" ? "התחברות עם אימייל" : "Sign in with email"}
                  </button>
                  ...
                  >
                    ...
                    {locale === "he" ? "דלג והמשך כאורח" : "Skip and continue as guest"}
                  </button>
                </>
              ) : (
                <>
                  ...
                  <button
                    ...
                    className="mb-3 flex items-center gap-1.5 text-sm text-gray-400 hover:text-gray-600 transition-colors"
                  >
                  ...
                  <SignIn
                    ...
                    appearance={{
                      ...
                      elements: {
                        ...
                        dividerRow: "hidden",
                        formButtonPrimary:
                          "bg-brand hover:bg-brand/90 shadow-sm shadow-brand/20",
                        footerActionLink: "text-brand hover:text-brand/80",
                        identityPreviewEditButton: "text-brand",
                        formFieldInput:
                          "border-gray-200 bg-gray-50 text-gray-900 focus:border-brand focus:ring-1 focus:ring-brand/30",
                      },
                    }}
                    routing="virtual"
                  />
              ...
              <div className="flex-1 flex flex-col p-8">
                ...
                {!showEmailForm ? (
                  <div className="flex-1 flex flex-col justify-center">
                    ...
                    <button
                      onClick={() => setShowEmailForm(true)}
                      className="w-full flex items-center justify-center gap-2 rounded-xl bg-brand px-4 py-3.5 text-sm font-medium text-white shadow-sm shadow-brand/20 hover:bg-brand/90 transition-all active:scale-[0.98]"
                    >
                      {locale === "he" ? "התחברות עם אימייל" : "Sign in with email"}
                    </button>
                    ...
                    <div className="mt-6 pt-5 border-t border-gray-100 text-center">
                      <button
                        onClick={handleSkip}
                        className="group inline-flex items-center gap-2 text-sm text-gray-400 hover:text-gray-600 transition-colors"
                      >
                        <Globe2 className="size-3.5" />
                        {locale === "he"
                          ? "דלג והמשך כאורח"
                          : "Skip and continue as guest"}
                        <ArrowRight className="size-3 opacity-0 -translate-x-1 group-hover:opacity-100 group-hover:translate-x-0 transition-all rtl:rotate-180" />
                      </button>
                    </div>
                  </div>
                ) : (
